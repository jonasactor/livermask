...
def process_options():
    ...
    parser.add_option( "--nt",
                  type="int", det="nt", default=5,
                  help="number of timesteps/layers for LSN", metavar="int")
    parser.add_option( "--true_lse",
                  action="store_true", dest="true_lse", default=False,
                  help="use LSE kernels from numerical analysis", metavar="bool")
    global options
    global args
